...
public class Ejercicio2 {
    ...
    obtenida que va de 0 a 20. Para estar aprobado debe tener una nota mínima de
    14. A partir de esta información se debe mostrar:
    ...
    */
    ...
    while (preg==1){
        ...
        System.out.println("Cantida de estudiantes trasladados: "+traslado);
        System.out.println("Nota promedio de los alumnos aprobados: "+promedioAprobados);
        System.out.println("Nota promedio de los alumnos desaprobados: "+promedioDesaprobados);
